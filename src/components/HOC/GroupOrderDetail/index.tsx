									...
									<div className="grid gap-md">
										...
										<div className="span-4">
											<Input
												...
												disabled={true}
												label="Format"
												value={order?.format?.name || order?.format?.format || order?.width}
											/>
										</div>
										<div className="span-4">
											<Input
												...
												<CutDiagram
													...
													x={
														<Input
															...
															mini={true}
															disabled={true}
															value={`${detail?.separated_raw_materials_format?.name || detail?.separated_raw_materials_format?.format || ''} mm`}
															placeholder=" "
														/>
													}
													className="span-12"
