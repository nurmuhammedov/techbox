	...
	useEffect(() => {
		if (responseData?.group_order) {
			const mappedItems: IFormItem[] = responseData.group_order.map((groupOrder) => ({
				...
				pallet: String(groupOrder.pallet_count_after_glue || groupOrder.pallet_count_after_bet || groupOrder.pallet_count_after_flex || groupOrder.pallet_count_after_gofra || groupOrder.count || ''),
